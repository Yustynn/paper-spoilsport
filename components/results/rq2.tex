...
This failure is largely attributed to how we specify the \minsupply goal (\todo{see Section XXX}), which hides 
...
\todo{Figure 5 does not seem to be referenced anywhere.}
