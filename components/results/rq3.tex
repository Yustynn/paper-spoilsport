...
Goal violations provide three interesting sources of information during analysis.
...
\todo{from this paragraph, it is not clear how the goal violations allowed to enrich the dataset. The high-level reasoning is missing, like why conceptually it can 
and the description mentions manual analysis, which further makes the matter confusing.}
