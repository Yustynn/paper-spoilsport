...
\revs{
    However, this introduces the concern that some unintended user will first call \texttt{transferFrom()}.
...
\begin{results}
    Goal violations enrich the dataset by revealing 105 misclassifications, 964 unlabelled \textit{Token Generation}-type rug pull mechanics, and provide examples of rug mechanics being used.
\end{results}