...
Similar to our work, TokenAuditor~\cite{tokenauditor_qrs22} uses a fuzzing-based approach.
...
Wu et al.~\cite{fuzzer_survey_2024} present a recent survey on smart contract fuzzers.
Similar to our work, several works use static and dynamic dataflow-based guidance~\cite{smartian_ase21,ethploit,ir-fuzz_ifs23} to construct targeted transaction sequences.
