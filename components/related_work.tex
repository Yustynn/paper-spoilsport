...
While these techniques are useful to improve our tool, our task required a custom fuzzer to tightly integrate the role/goal specification format, including optimization and call capabilitiy goals, and implement the motivation analysis.
