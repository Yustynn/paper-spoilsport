...
Existing fuzzers typically either rely on manual deployment scripts \todo{cite}, fork full \todo{cite}, potentially complex on-chain state \todo{cite} or else search for states 
that are well-positioned for discovering security vulnerabilities \todo{cite}, rather than usage-realism.
