...
\todo{please include the pseudocode of the fuzzing process}

\todo{Even though this section is a key component, currently, it is hard to follow. Apart from adding the pseudocode, 
I believe it needs to refer back to the example for each paragraph.}
...
\todo{Shouldn't this section be before Fuzzing?}
