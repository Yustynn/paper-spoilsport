...
We generate function-level summaries which capture the following information:
\begin{enumerate}
...
\spoilsport takes user-supplied specification of roles and goals.
...
We keep the roles and goals general enough to reasonably represent ERC-20 users in general.
